...
(() => {
    function startup() {
        ...
        function initDrag(e) {
            // this is not directly visible since the element has no background
            // or content. this just means that while you're clicking+dragging
            // the resizer, its width expands to double the size of the sidebar.
